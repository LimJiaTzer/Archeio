...
export default function About() {
  return (
    <Layout>
      <main className="responsive-page mx-auto flex min-h-[calc(100dvh-7rem)] max-w-2xl flex-col justify-between">
      <div className="w-full py-6 text-center sm:py-12">
        <Link to="/" className="inline-flex items-center gap-2 text-stone-600 hover:text-stone-900 mb-8 font-medium">
          <ArrowLeft className="w-5 h-5" />
          <span>Back to Home</span>
        </Link>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-stone-900 mb-4">About Archeío</h1>
        ...
        <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-sm text-left">
